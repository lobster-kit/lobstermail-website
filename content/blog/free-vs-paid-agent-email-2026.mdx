...
| 10+ agents or high-volume sends | [Read this first](/blog/running-50-agent-inboxes) |

Agent in development? Free. Agent running in production with real sends? Builder at $9. Agent running at serious scale? Read [how to handle 50 agent inboxes](/blog/running-50-agent-inboxes) before deciding.
