...
<FAQ>
  ...
  <FAQItem question="Can I use LobsterMail with a custom domain?">
    Yes, on the Builder plan and above. You'll need to configure MX records pointing to LobsterMail's mail servers. See [the custom domains guide](/blog/custom-domains-agent-email) for exact setup steps and how to verify propagation.
  </FAQItem>
