...
type: blog-post
status: approved
approved_at: '2026-03-09T07:17:08.468Z'
---
...
This is where domain reputation matters. Sending from `closing@yourbrokerage.com` with proper [SPF](/glossary/spf), [DKIM](/glossary/dkim), and [DMARC](/glossary/dmarc) records is the difference between your emails being read and your emails being ignored. If your agent needs to [schedule meetings over email](/blog/agent-schedule-meetings-email) with inspectors or title officers, those emails need to land in the primary inbox.
