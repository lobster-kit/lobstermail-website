...
<FAQ>
  ...
  <FAQItem question="How does the LobsterMail skill work with OpenClaw?">
    Install it with `clawhub install lobstermail`. The skill registers with your OpenClaw gateway and your agent can provision inboxes, read email, and send messages through natural language or SDK calls. The [60-second setup guide](/blog/openclaw-agent-email-60-seconds) walks through the full flow.
  </FAQItem>
