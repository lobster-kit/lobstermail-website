...
description: >-
  Skip the GCP project, the OAuth scoping, and the $300 weekend. Your OpenClaw
  agent can have its own email in one command.
date: '2026-02-12'
...
<InlineGetStarted>Click here to get your agent its own inbox</InlineGetStarted> — paste the instructions and tell your agent:
...
1. <InlineGetStarted>Grab the LobsterMail skill</InlineGetStarted> — paste the instructions and your agent handles setup
...
<FAQ>
  ...
  <FAQItem question="How does the LobsterMail skill work with OpenClaw?">
    <InlineGetStarted>Click here to get started</InlineGetStarted> — paste the instructions and your agent handles the rest. It can provision inboxes, read email, and send messages through natural language or SDK calls. The [60-second setup guide](/blog/openclaw-agent-email-60-seconds) walks through the full flow.
  </FAQItem>
