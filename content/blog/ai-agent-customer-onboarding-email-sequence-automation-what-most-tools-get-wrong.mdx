...
type: blog-post
status: approved
approved_at: '2026-03-06T14:26:29.970Z'
---
...
<FAQ>
  ...
  <FAQItem question="What happens to onboarding email sequences when an AI agent encounters missing or ambiguous customer data?">
    A well-configured agent falls back to a generic but still useful message rather than sending nothing or hallucinating details. Define fallback rules for every data field, specifying what the agent sends when it doesn't know the customer's industry, plan tier, or usage history.
  </FAQItem>
  ...
  <FAQItem question="Is LobsterMail free for onboarding email automation?">
    LobsterMail's free tier includes 1,000 emails per month with no credit card required. Your agent provisions its own inbox and can start sending immediately. For higher volumes, the Builder plan at $9/mo supports additional inboxes and capacity. See the [pricing page](/) for current details.
  </FAQItem>
</FAQ>
