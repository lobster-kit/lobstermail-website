...
<FAQ>
  ...
  <FAQItem question="Why shouldn't I use Gmail OAuth for my OpenClaw agent?">
    Gmail OAuth requires browser-based human authentication that an agent can't complete on its own. [Tokens](/glossary/tokens) expire and need re-authorization, and the setup is tied to a personal Google account that wasn't designed for agent use.
  </FAQItem>
