...
<Callout type="tip">
  For OpenClaw, the fastest path is `clawhub install lobstermail`. Your agent installs the skill and hatches its own inbox without you touching a config file. The [60-second walkthrough](/blog/openclaw-agent-email-60-seconds) covers the full setup.
</Callout>
