...
<FAQ>
  ...
  <FAQItem question="Can I use a custom domain with LobsterMail?">
    Yes. You can provision inboxes at your own domain instead of `@lobstermail.ai`. Setup instructions are in the [custom domains guide](/docs/custom-domains).
  </FAQItem>
