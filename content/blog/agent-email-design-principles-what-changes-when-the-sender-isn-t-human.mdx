...
<FAQ>
  ...
  <FAQItem question="How does agentic AI personalize email without sacrificing design integrity?">
  ...
  <FAQItem question="What authentication and identity principles apply when agents send email on behalf of a brand?">
    Set up SPF, DKIM, and DMARC on your sending domain. Use a "From" name that matches what recipients expect (product name or team name, not "AI Bot"). With LobsterMail, agents can send from custom domains with authentication handled automatically.
  </FAQItem>
</FAQ>
