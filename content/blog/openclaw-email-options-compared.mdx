...
That's the whole setup. If you're using OpenClaw, you can skip the code entirely: `clawhub install lobstermail`, then tell your agent "get yourself an email inbox." The [60-second walkthrough](/blog/openclaw-agent-email-60-seconds) covers the full flow.
