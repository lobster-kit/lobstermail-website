...
If your agent sends both types, you want at least two inboxes on separate subdomains with distinct sending reputations. The [Builder tier at $9/month](/pricing) gives you up to 10 inboxes, which is enough to run transactional and marketing pipelines on isolated infrastructure.
