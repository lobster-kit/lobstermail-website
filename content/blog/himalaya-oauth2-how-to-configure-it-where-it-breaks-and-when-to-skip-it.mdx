---
title: 'himalaya oauth2: how to configure it, where it breaks, and when to skip it'
description: >-
  A practical guide to setting up OAuth2 in the Himalaya CLI email client for
  Gmail and Outlook, plus what to do when it falls apart in headless
  environments.
date: '2026-03-09'
...
type: blog-post
status: approved
approved_at: '2026-03-10T07:03:58.722Z'
---
