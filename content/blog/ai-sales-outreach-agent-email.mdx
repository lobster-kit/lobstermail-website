...
The Builder tier gives your agent 1,000 sends per day with up to 3 custom domains for $9/month, with the reputation isolation that keeps your campaigns independent from each other.
...
<FAQ>
  ...
  <FAQItem question="How many cold emails can I send per day on LobsterMail?">
    The Builder tier supports 1,000 sends per day. These limits are enforced atomically to prevent accidental volume spikes that could damage your domain reputation.
  </FAQItem>
