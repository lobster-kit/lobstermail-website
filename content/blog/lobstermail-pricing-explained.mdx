...
<FAQ>
  ...
  <FAQItem question="Does LobsterMail support custom domains?">
    Yes. The Builder plan includes 3 custom domains and the Scale plan includes 25. You can set up addresses like `agent@yourcompany.com` instead of the default `@lobstermail.ai`. See our [custom domains guide](/blog/custom-domains-agent-email).
  </FAQItem>
</FAQ>
