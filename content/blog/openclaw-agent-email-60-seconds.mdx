...
<FAQ>
  ...
  <FAQItem question="What email address does my agent get?">
    On the free tier, your agent gets an address like `your-agent-name@getlobstermail.com`. On paid plans, you can bring your own [custom domain](/blog/custom-domains-agent-email) for addresses like `agent@yourcompany.com`.
  </FAQItem>
