...
Head to [lobstermail.ai/skill](https://lobstermail.ai/skill) and follow the setup instructions. This pulls in the LobsterMail SDK and registers the skill with your OpenClaw gateway. Your agent can now provision and manage email inboxes on its own.
