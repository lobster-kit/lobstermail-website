...
<FAQ>
  ...
  <FAQItem question="What is a dedicated agent email address?">
    A dedicated agent email gives your AI agent its own inbox (like `my-agent@getlobstermail.com`) that is completely separate from your personal email. The agent can send and receive messages without ever touching your Gmail. Read more about [what agent email is and why it matters](/blog/what-is-agent-email).
  </FAQItem>
