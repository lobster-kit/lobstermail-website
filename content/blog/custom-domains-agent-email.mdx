...
description: "Your agent doesn't have to send from @getlobstermail.com. Set up a custom domain so it sends from support@yourcompany.com."
date: "2026-02-10"
...
<FAQ>
  ...
  <FAQItem question="Can I switch my agent from @getlobstermail.com to a custom domain later?">
