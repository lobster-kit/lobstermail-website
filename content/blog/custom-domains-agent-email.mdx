...
<Callout type="tip">
  Custom domains are available on the Builder plan at $9/month. If you're currently on the free tier, your agent can handle the upgrade itself (just ask it to molt up). See [LobsterMail pricing explained](/pricing) for the full breakdown.
</Callout>
