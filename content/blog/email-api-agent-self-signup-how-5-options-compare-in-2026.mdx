...
<FAQ>
  ...
  <FAQItem question="Can I use a custom domain with LobsterMail instead of @lobstermail.ai?">
    Yes. Custom domain support is available. See the [custom domains guide](/docs/custom-domains) for setup instructions. Your agent can then provision inboxes on your own domain rather than the default `@lobstermail.ai` addresses.
  </FAQItem>
