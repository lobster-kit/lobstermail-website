...
description: >-
  Sometimes your agents need to coordinate. Email gives them a structured,
  auditable communication channel without custom protocols.
date: '2026-02-28'
...
research-bot@lobstermail.ai   writer-bot@lobstermail.ai  review-bot@lobstermail.ai
        |                            |                          |
        |--- findings email -------->|                          |
        |                            |--- draft email --------->|
        |                            |<-- feedback email -------|
...
console.log(researcher.address); // research-bot@lobstermail.ai
console.log(writer.address);     // writer-bot@lobstermail.ai
console.log(reviewer.address);   // review-bot@lobstermail.ai
```
...
```javascript
await client.send({
  from: "research-bot@lobstermail.ai",
  to: "writer-bot@lobstermail.ai",
