...
type: blog-post
status: approved
approved_at: '2026-03-06T14:26:29.987Z'
---
...
<FAQ>
  ...
  <FAQItem question="How much does it cost to run a showing scheduling agent?">
    Receiving emails on LobsterMail's Free tier costs nothing. Sending replies requires a paid plan; the Builder plan starts at $9/mo. LLM costs for parsing and generating scheduling emails are minimal since the messages are short and structured.
  </FAQItem>
  ...
  <FAQItem question="Can I use this with LobsterMail's free plan?">
    You can receive and read showing requests on the Free plan. To have the agent send replies and confirmations, you'll need a paid plan like Builder ($9/mo). See [LobsterMail pricing](/blog/lobstermail-pricing-explained) for details.
  </FAQItem>
</FAQ>
