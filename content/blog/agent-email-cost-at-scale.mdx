...
LobsterMail's [$9 Builder tier](/pricing) was designed for that gap: up to 10 inboxes, 5,000 emails/month, 500 sends per day. For most teams in the 10-50 range, that's the tier where the numbers actually fit the workload. For larger fleets, the math shifts further, but the principle holds, the right tier is the one that matches your inbox count without forcing you up a price step for capacity you don't use.
...
<FAQ>
  ...
  <FAQItem question="What does the LobsterMail Builder tier include?">
    The Builder tier is $9/month and covers up to 10 inboxes, 5,000 emails/month, and 500 sends per day. See the [full pricing breakdown](/pricing) for details.
  </FAQItem>
