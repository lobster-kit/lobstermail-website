...
This is what [agent email](/blog/what-is-agent-email) is designed for. Your agent gets an address like `support-bot@getlobstermail.com` and communicates through that. Your personal inbox stays untouched, out of the context window, out of reach.
