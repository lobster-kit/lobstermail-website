...
<FAQ>
  ...
  <FAQItem question="How do I get started with LobsterMail for my CrewAI project?">
    For Node.js environments, install with `npm install @lobsterkit/lobstermail`. For Python-based crews, call the REST API directly. The [getting started guide](/docs/getting-started) walks through the full setup in a few minutes, and the free plan requires no credit card.
  </FAQItem>
</FAQ>
