...
| Deliverability tools | Manual SPF/DKIM setup | Usually handled by provider |
| Authentication | Username/password or app passwords | API keys, OAuth tokens, or auto-provisioned |
| Bounce handling | Parse async bounce emails | Webhook callbacks or status endpoints |
