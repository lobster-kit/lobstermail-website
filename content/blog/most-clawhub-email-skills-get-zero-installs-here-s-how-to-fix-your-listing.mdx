...
type: blog-post
status: approved
approved_at: '2026-03-06T14:26:29.993Z'
---
ClawHub crossed 5,700 skills in early 2026. That's a lot of competition for attention. The email category is one of the most crowded, because every agent eventually needs to send or receive mail, and every developer eventually tries to build a skill for it.
...
<FAQ>
  ...
  <FAQItem question="What should a ClawHub skill README include?">
    A one-line description, a quick-start code example (2-3 lines), a capabilities list, and security notes if you handle inbound email. Skip installation instructions, since ClawHub handles that.
  </FAQItem>
