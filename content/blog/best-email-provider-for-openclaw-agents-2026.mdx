...
<Callout type="info">
  LobsterMail is currently in pre-launch. [Join the waitlist](/) for early access, or <InlineGetStarted>get the ClawHub setup instructions here</InlineGetStarted> — paste them and your agent handles the rest.
</Callout>
...
Yes. The LobsterMail skill is available on ClawHub. <InlineGetStarted>Click here to get your agent its own inbox</InlineGetStarted> — paste the instructions and your agent handles the rest. The [60-second walkthrough](/blog/openclaw-agent-email-60-seconds) shows it in action.
