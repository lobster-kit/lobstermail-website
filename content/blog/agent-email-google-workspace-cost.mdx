...
description: >-
  ClawEmail plus Google Workspace plus GCP billing adds up fast. Here's the
  actual math for running 5 agents on Gmail vs. a dedicated platform.
date: '2026-03-01'
...
| [Prompt injection](/glossary/prompt-injection) scanning | No | No | Yes |
...
<FAQ>
  ...
  <FAQItem question="Can my agent use a custom domain with Google Workspace?">
    Yes, but custom domains on Google Workspace require domain verification, [MX record](/glossary/mx-record) configuration, and [SPF](/glossary/spf)/[DKIM](/glossary/dkim)/[DMARC](/glossary/dmarc) setup through both Google Admin and your DNS provider. LobsterMail also supports custom domains on the $9/month Builder tier, with automated DNS verification.
  </FAQItem>
