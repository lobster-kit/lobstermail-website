...
<FAQ>
  ...
  <FAQItem question="Does OpenClaw support email integrations out of the box?">
    OpenClaw doesn't include a built-in email provider. You need to connect one via a skill or MCP server. LobsterMail's SDK works as an OpenClaw skill, and the [MCP server](/docs/getting-started) gives your agent email tools with zero code.
  </FAQItem>
</FAQ>
