...
<Callout type="tip">
If you're building a travel agent that needs to receive booking confirmations directly, check out [LobsterMail's getting started guide](/docs/getting-started). The free tier gives your agent its own inbox with no configuration required.
</Callout>
