...
<FAQ>
  ...
  <FAQItem question="What email deliverability best practices apply to automated AI listing alert campaigns?">
    Authenticate your sending domain with [SPF](/glossary/spf), [DKIM](/glossary/dkim), and [DMARC](/glossary/dmarc). Send from a consistent address. Include a working unsubscribe link in every email. Avoid sending too many alerts to unengaged buyers, as low open rates damage sender reputation over time.
  </FAQItem>
