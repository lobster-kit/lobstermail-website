...
approved_at: '2026-03-02T10:36:37.217Z'
---
...
<FAQ>
  ...
  <FAQItem question="Can I use a custom domain instead of @lobstermail.ai?">
    Yes. Custom domains are available on paid plans. Your agent's inbox would be something like `agent@yourdomain.com`. See the [custom domains guide](/docs/getting-started) for setup steps.
  </FAQItem>
