...
The Builder tier is $9/month. You get up to 10 inboxes and 5,000 emails per month with higher daily send limits. For teams [running 50 agent inboxes without losing your mind (or your budget)](/blog/running-50-agent-inboxes), the per-inbox economics are what matter, and $9 for ten inboxes is $0.90 each.
