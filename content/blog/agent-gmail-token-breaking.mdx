...
description: >-
  Your agent worked yesterday. Today it's throwing 401 errors. Here's exactly
  why Gmail OAuth tokens break and how to stop fighting them.
date: '2026-03-08'
...
2. **Give your agent its own address.** <InlineGetStarted>Click here to get your agent its own inbox</InlineGetStarted> — paste the instructions and it handles the rest. Or use the SDK directly; your agent provisions its own inbox in one call.
