...
2. **Give your agent its own address.** Install the LobsterMail skill (`clawhub install lobstermail`) or use the SDK directly. Your agent provisions its own inbox in one call.
