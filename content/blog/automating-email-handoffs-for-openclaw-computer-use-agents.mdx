...
approved_at: '2026-03-02T10:36:37.188Z'
---
...
<FAQ>
  ...
  <FAQItem question="Will services reject the @lobstermail.ai domain as disposable?">
    Some aggressive spam filters block known disposable domains. For services with strict email validation, a [custom domain](/docs/getting-started) is the cleaner solution. For most SaaS signups and API trials, @lobstermail.ai passes without issue.
  </FAQItem>
  ...
  <FAQItem question="Does LobsterMail protect against prompt injection in emails?">
    Yes. Every email returned by the SDK includes security metadata and an injection risk score. If you're passing email body content to your agent, you can inspect the risk score before acting on it. The [security and injection guide](/docs/getting-started) covers the full protection model.
  </FAQItem>
