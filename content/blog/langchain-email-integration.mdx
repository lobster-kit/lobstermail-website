...
description: "LangChain's Gmail toolkit forces you through OAuth hell. Here's how to wrap LobsterMail's REST API as a custom tool and skip the entire dance."
date: "2026-02-22"
...
<FAQ>
  ...
  <FAQItem question="Can my LangChain agent send email from a custom domain?">
    Yes, on LobsterMail's $9/month Builder plan. You configure DNS records (SPF, DKIM, DMARC) for your domain, and your agent sends from addresses like `agent@yourcompany.com`. LobsterMail handles the DNS verification. See [custom domains for agent email](/blog/custom-domains-agent-email).
  </FAQItem>
</FAQ>
