...
description: >-
  Your agent handles the rest. Here are four real options for OpenClaw email and
...
<InlineGetStarted>Click here to get your agent its own inbox</InlineGetStarted> — paste the instructions and tell your agent: "get yourself an email inbox."
...
If you want your agent to handle the whole thing, from signup to receiving its first email, in about a minute: <InlineGetStarted>start here</InlineGetStarted> — paste the instructions and your agent handles the rest.
...
<FAQ>
  <FAQItem question="How do I get an email for my OpenClaw agent?">
    <InlineGetStarted>Click here to get your agent its own inbox</InlineGetStarted> — paste the instructions and tell your agent to get itself an inbox. The agent provisions its own email address and can receive mail immediately.
  </FAQItem>
