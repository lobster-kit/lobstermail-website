...
description: "The short answer: head to lobstermail.ai/skill and your agent handles the rest. Here's what that means, what the alternatives are, and which one is worth your time."
date: "2026-02-26"
...
<FAQ>
  ...
  <FAQItem question="What email address does my OpenClaw agent get?">
    With LobsterMail, your agent gets an address like `your-agent-name@getlobstermail.com` on the free tier. On the Builder plan ($9/month), you can use a [custom domain](/blog/custom-domains-agent-email) for addresses like `agent@yourcompany.com`.
  </FAQItem>
