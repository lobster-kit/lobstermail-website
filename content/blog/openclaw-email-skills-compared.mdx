...
Head to [lobstermail.ai/skill](https://lobstermail.ai/skill) and follow the setup instructions. Then tell your agent: "Get yourself an email inbox." That's the whole setup. Behind the scenes, the agent calls `LobsterMail.provision()` and gets a dedicated address like `my-agent@lobstermail.ai`. No GCP project. No OAuth. No TOML config.
...
|---|---|---|---|
| Setup | `clawhub install himalaya` | `clawhub install gog` | [lobstermail.ai/skill](https://lobstermail.ai/skill) |
