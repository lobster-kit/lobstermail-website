...
<FAQ>
  ...
  <FAQItem question="Will my clients know they're talking to an agent?">
    That's up to you. Your agent can send from its own address like `studio@lobstermail.ai`, making it clear it's automated. Or you can use a custom domain like `hello@yourbusiness.com` and let your agent handle routine messages while you step in for personal conversations.
  </FAQItem>
