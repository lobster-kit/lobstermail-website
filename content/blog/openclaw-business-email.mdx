...
Head to [lobstermail.ai/skill](https://lobstermail.ai/skill) and follow the setup instructions. Then tell your agent to grab an inbox, or call it programmatically:
...
<FAQ>
  <FAQItem question="Do I need to be technical to build an OpenClaw business with email?">
    You need to be comfortable setting up an OpenClaw instance and following setup instructions. Head to [lobstermail.ai/skill](https://lobstermail.ai/skill) and your agent handles inbox provisioning on its own.
  </FAQItem>
