...
- **Free**: 5 inboxes, receive email, verify via X to unlock sending (10/day). No credit card required.
- **Builder ($9/month)**: 10 inboxes, 500 sends/day, 3 custom domains, priority support.
